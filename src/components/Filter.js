    ...
    <div className="py-16 text-white" style={{ backgroundColor: '#1B2124' }}>
      <div class="flex flex-row justify-center content-center">
        ...
        <div className="mx-16">
          ...
          <div id="dropdownDivider" className="z-10 text-base list-none bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
        ...
        <div className="mx-16">
          ...
          <div id="dropdownDivider" className="z-10 text-base list-none bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
            <ul className={`py-1 ${openYears ? 'show' : 'hidden'} `} aria-labelledby="dropdownDividerButton">
              {tahun.map((tahun) => (
                <li
                  key={tahun}
                  onClick={() => {
