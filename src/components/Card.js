const Card = ({ content }) => {
  return (
    <div className="flex flex-col items-center justify-center py-6 mb-6 bg-gray-900 rounded-lg px-28" style={{ backgroundColor: '#04A3DD', height: '431px' }}>
      ...
      <p className="mb-6 text-2xl font-bold">{content.name}</p>
      <div className="flex">
